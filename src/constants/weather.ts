export const WEATHER_ICONS: { [key: string]: string | undefined } = {
  ...
  'Patchy freezing drizzle possible': '/icons/patchy-freezing-drizzle-possible.svg',
  ...
  'Moderate or heavy rain with thunder': '/icons/rain-with-thunder.svg',
  'Patchy light snow with thunder': '/icons/snow-with-thunder.svg',
  'Moderate or heavy snow with thunder': '/icons/snow-with-thunder.svg',
